...
const styles = StyleSheet.create({
  ...
  clearText: { color: COLORS.red, fontFamily: FONTS.bodySemi, fontSize: 12 },
  ...
  routeMeta: { color: COLORS.text2, fontFamily: FONTS.bodyRegular, fontSize: 12 },
  routeName: { color: COLORS.text, fontFamily: FONTS.soraBold, fontSize: 16 },
  routeRow: {
