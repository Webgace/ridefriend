...
const styles = StyleSheet.create({
  ...
  btn: { alignItems: 'center', borderRadius: 14, flex: 1, paddingVertical: 13 },
  ...
  starText: { color: COLORS.gray300, fontFamily: FONTS.soraBold, fontSize: 40 },

  starTextActive: { color: COLORS.amber },

  starsRow: { flexDirection: 'row', gap: 8, justifyContent: 'center' },
  subtitle: { color: COLORS.text2, fontFamily: FONTS.bodyRegular, fontSize: 13, marginTop: -10 },
  tag: {
  ...
  tagText: { color: COLORS.text2, fontFamily: FONTS.bodySemi, fontSize: 12 },
