...
const styles = StyleSheet.create({
  ...
  iconText: { fontFamily: FONTS.soraBold, fontSize: 18, color: COLORS.navy },
  body: { flex: 1, gap: 4 },
  name: { fontFamily: FONTS.soraBold, fontSize: 14, color: COLORS.text },
  ...
  ratingTagLabel: { fontFamily: FONTS.bodySemi, fontSize: 11, color: COLORS.text2 },
  ...
  expandedLabel: { fontFamily: FONTS.bodySemi, fontSize: 11, color: COLORS.text3, marginTop: 4 },
  expandedValue: { fontFamily: FONTS.bodyRegular, fontSize: 12, color: COLORS.text },
});
