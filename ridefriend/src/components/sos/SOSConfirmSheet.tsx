...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: FONTS.soraBold, fontSize: 20, color: COLORS.red },
  body: { fontFamily: FONTS.bodyRegular, fontSize: 14, color: COLORS.text2 },
  row: { gap: 2 },
  rowLabel: { fontFamily: FONTS.bodySemi, fontSize: 12, color: COLORS.text2 },
  rowValue: { fontFamily: FONTS.bodySemi, fontSize: 14, color: COLORS.text },
  countdown: {
    marginTop: 4,
