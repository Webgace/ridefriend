...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: FONTS.soraBold, fontSize: 22, color: COLORS.text },
  ...
  currentLabel: { fontFamily: FONTS.bodySemi, fontSize: 12, color: COLORS.text2 },
  currentValue: { fontFamily: FONTS.soraBold, fontSize: 16, color: COLORS.text },
  testBtn: {
    marginTop: 6,
  ...
  warningText: { fontFamily: FONTS.bodySemi, fontSize: 13, color: COLORS.red },
  ...
  contactName: { fontFamily: FONTS.bodySemi, fontSize: 14, color: COLORS.text },
  contactPhone: { fontFamily: FONTS.bodyRegular, fontSize: 12, color: COLORS.text2 },
  sep: { height: 8 },
  ...
  externalForm: { padding: 16, gap: 10 },
  input: {
    backgroundColor: COLORS.white,
    borderRadius: 14,
